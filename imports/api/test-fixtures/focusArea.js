...
export const populateComputerGraphicsFocusAreaRequirementsFixture = function populateComputerGraphicsFocusAreaRequirementsFixture()  {
  ...
  const primaryModules = ['CS3241', 'CS3242', 'CS3247'];
  const primaryFourThousandModules = ['CS4247', 'CS4350'];
  ...
  listOfFocusAreas.push(createNewFocusArea(requirementName, primaryModules, primaryFourThousandModules, fourThousandModules, nonPrimaryModules));
