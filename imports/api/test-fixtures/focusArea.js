...
export const populateComputerGraphicsFocusAreaRequirementsFixture = function populateComputerGraphicsFocusAreaRequirementsFixture()  {
  ...
  const primaryFourThousands = ['CS4247', 'CS4350'];
  ...
  listOfFocusAreas.push(createNewFocusArea(requirementName, primaryModules, primaryFourThousands, fourThousandModules, nonPrimaryModules));
